(function () {
  ...
  angular.module('pmApp')
    ...
    .controller('QuizQueController', quizQueController);

  quizQueController.$inject = ['$scope', '$timeout', 'localStorageService', 'QUIZQUE', '$state'];

  function quizQueController($scope, $timeout, localStorageService, QUIZQUE, $state) {
